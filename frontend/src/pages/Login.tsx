...
const Orb = ({ size, top, left, right, bottom, color, delay = 0, dur = 7 }: { size: any, top?: any, left?: any, right?: any, bottom?: any, color: any, delay?: number, dur?: number }) => (
  <Box
    sx={{
      position: 'absolute',
...
function Login() {
  ...
  const { loading, isAuthenticated, user } = useSelector((s: any) => s.auth);
