...
function SystemAdmin({ activeTab = 0 }) {
  ...
  return (
    <Box sx={{ 
      ...
      <Dialog open={openCreateModal} onClose={() => setOpenCreateModal(false)} PaperProps={{ sx: { borderRadius: 3, bgcolor: 'background.paper', color: 'text.primary' } }}>
      ...
      {/* Success Modal */}
      <Dialog open={openSuccessModal} onClose={() => setOpenSuccessModal(false)} PaperProps={{ sx: { borderRadius: 3, bgcolor: 'background.paper', color: 'text.primary' } }}>
