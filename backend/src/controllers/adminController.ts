...
export const formatNotification = (data: any): any => {
  if (!data) return null;
...
export const getWarningEmails = async (req: Request, res: Response) => {
  try {
...
export const saveWarningEmails = async (req: Request, res: Response) => {
...
export const getScreenshotRules = async (req: Request, res: Response) => {
  try {
...
export const saveScreenshotRules = async (req: Request, res: Response) => {
...
export const getProductivitySettings = async (req: Request, res: Response) => {
  try {
    if (!req.user!.companyId) {
...
export const saveProductivitySettings = async (req: Request, res: Response) => {
...
export const getCompanyDetailsMap = () => {
  try {
    if (!fs.existsSync(companyDetailsPath)) {
      const dir = path.dirname(companyDetailsPath);
...
export const saveCompanyDetailsMap = (map: any) => {
  try {
...
export const deleteCompany = async (req: Request, res: Response) => {
  try {
    ...
    if (users && users.length > 0) {
      // Chunk user IDs in case there are many
